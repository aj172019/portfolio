...
export const headerProps = [
    ...
    {title: '#Projects', description: '나의 프로젝트', link: '/#projects', icon: 'heroicons:cube-solid', sectionIndex: 2, status: 'done'},
    {title: '#Introduce', description: '나의 소개', link: '/#introduce', icon: 'heroicons:user-solid', sectionIndex: 3, status: 'working'},
...
export const navigationProps = [
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="black" class="w-3 h-3">
